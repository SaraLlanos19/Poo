...
public class FabricaDeTraje implements IFabricaDeTrajes {
    ...
    public FabricaDeTraje() {
        componentesAlmacen = new ArrayList<>();
        trajesAlmacen = new TreeSet<>();
        listadoDeEnvios = new ArrayList<>();
    }
    
    public void insertarDatosDeEnsayo(){
        System.out.println("inicie insertar datos de ensayo");
        Blusa blusa = new Blusa(12, "blusa12", "s", "roja", true, 12000, true);
        componentesAlmacen.add(blusa);
        Blusa blusa2 = new Blusa(15, "blusaM", "m", "verde", true, 12000, false);
        componentesAlmacen.add(blusa2);
        
        Pantalon pantalon = new Pantalon(33, "pantalon", "s", "rojo",false,100,true);
        componentesAlmacen.add(pantalon);
        Pantalon pantalon2 = new Pantalon(123, "pan", "s", "rojo",false,100,true);
        componentesAlmacen.add(pantalon2);
        
        Falda falda = new Falda(10, "falda", "m", "rojo", false, 1000, true);
        componentesAlmacen.add(falda);
        Falda falda2 = new Falda(11, "fal", "m", "rojo", false, 1000, true);
        componentesAlmacen.add(falda2);
        
        Chaqueta chaqueta = new Chaqueta(22,"chaqueta","s","rojo",false,100,4);
        componentesAlmacen.add(chaqueta);
        Chaqueta chaqueta2 = new Chaqueta(25,"chaq","s","rojo",false,100,4);
    ...
    private void validarExistenciaManga(Blusa blusaNueva) throws MangaException{
        ...
        boolean mangaLargaBlusa = blusaNueva.isConMangaLarga();
        for(Componente componenteRecorreLista : componentesAlmacen){
            ...
            if(componenteRecorreLista instanceof Blusa && componenteRecorreLista.getColor().equals(colorBlusaGuardada) ){
                boolean mangaLarga = ((Blusa) componenteRecorreLista).isConMangaLarga();
    ...
    public void listarComponentes() {
        ...
        for(Componente componenteRecorreLista : componentesAlmacen){
            contador++;
            System.out.println("Fila " + contador + ":" + " " + componenteRecorreLista.toString());
        }
